...
public class GLView extends NonThreadSafe implements IGLView {
    ...
    public void RemoveAllView() {
        ...
        CopyOnWriteArrayList<GLView> tmp = (CopyOnWriteArrayList<GLView>)mChildViews.clone();
    ...
    public boolean onScroll(float start_x, float start_y, float cur_x,
        ...
        if (mTouchTargetGlView == null) {
            ...
            handled = mTouchTargetGlView.onScroll(start_x, start_y, cur_x, cur_y, distanceX,
                    distanceY);
        }
    ...
    public boolean onFling(float start_x, float start_y, float cur_x,
        ...
        if (mTouchTargetGlView == null) {
            ...
            handled = mTouchTargetGlView.onFling(start_x, start_y, cur_x, cur_y, velocityX,
                    velocityY);
        }
